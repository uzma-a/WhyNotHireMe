        ...
        <div style={{ background: "var(--card)", border: "1px solid var(--border)", borderRadius: 16, padding: 36 }}>
          ...
          <form onSubmit={handleLogin}>
            ...
            <button type="submit" disabled={loading} style={{
              ...
              {loading ? (
                <><span className="spinning" style={{ width: 16, height: 16, border: "2px solid rgba(0,0,0,0.3)", borderTopColor: "#0a0a0f", borderRadius: "50%", display: "inline-block" }} /> Logging in…</>
              ) : "Login →"}
            </button>
          </form>
